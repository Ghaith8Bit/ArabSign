...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/dashboard/pages/home/css/nucleo-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/dashboard/pages/home/css/nucleo-svg.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/dashboard/pages/home/css/soft-ui-dashboard-tailwind.css') }}">
...
<body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    ...
    <script src="{{ asset('assets/dashboard/pages/home/js/perfect-scrollbar.min.js') }}"></script>
</body>
