<a href="#" class="group relative block bg-black rounded-3xl hover:scale-105 transition delay-150 cursor-default"
    ...
    <div class="relative p-4 sm:p-6 lg:p-8" dir="ltr">
        ...
        <div
            class="absolute inset-0 flex items-center justify-evenly opacity-0 transition-opacity group-hover:opacity-100 top-[20%] ease-in delay-150 translate-y-0 z-40">
            <!--icon for play-vedio-->
            ...
            <i class="fa-solid fa-trash text-red-500 hover:text-red-700 text-2xl mx-2 opacity-70 cursor-pointer"
                onclick="openDeleteModal( {{ $resource->id }} , '{{ route('dashboard.library.destroy', $resource->id) }}' )"></i>
        </div>
    </div>
