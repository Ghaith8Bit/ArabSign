<tr>
    ...
    <td class="py-14 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent bg-contain bg-no-repeat bg-left"
    ...
    <td class="p-2 align-middle border-b whitespace-nowrap text-center">
        <div class="dropdown inline-block">
            ...
            <div id="dropdownMenu{{ $content->id }}"
                class="dropdownMenu hidden absolute right-[3rem] w-48 bg-white border rounded shadow-lg z-40">
