<section class="flex flex-col gap-14 mt-24">
    ...
    <div
        class="container bg-neutral-100 rounded-3xl shadow-lg shadow-slate-800/40 mx-auto p-8 flex flex-col gap-8 relative w-[80%] lg:w-[90%] xl:w-full">
        <img src="{{ asset('assets/website/pages/home/images/points.svg') }}" alt="نقاط"
            class="absolute top-2 right-8 hidden md:block">
        <div class="self-center">
            <h3 class="text-center text-3xl">خدماتنا</h3>
        </div>
