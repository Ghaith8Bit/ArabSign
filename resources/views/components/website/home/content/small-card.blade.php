<article class="shadow-lg shadow-slate-800/40 rounded-2xl w-[100%] lg:w-full flex flex-row p-2 gap-x-3 ">
    <a href="#" class="cursor-pointer relative my-auto">
        <img alt="Lava" src="{{ asset('assets/website/pages/home/images/content/post.svg') }}"
            class="lg:h-32 lg:w-96 md:h-32 md:w-64 rounded-xl object-cover shadow-xl blur-[0.6px] transition" />
    ...
    <div>
        <h3 class="sm:text-lg text-sm font-medium text-gray-900 my-auto">Finding the Journey to Mordor</h3>
        <p class="mt-2 lg:text-sm/relaxed md:text-md/relaxed text-sm/relaxed text-gray-500 smallCardText">
